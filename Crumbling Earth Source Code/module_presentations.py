  ...
  ("banner_selection",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (overlay_set_position, reg1, pos1),
        (overlay_set_text, reg1, s1),
        (create_text_overlay, "$g_presentation_obj_banner_selection_1", s0, tf_center_justify|tf_scrollable),
        (position_set_x, pos1, 0),
        (position_set_y, pos1, 75),
        ...
        (set_container_overlay, "$g_presentation_obj_banner_selection_1"),
		
        (assign, ":x_pos", 150),
        (assign, ":y_pos", 6750), ##250 per line (8 banners)
        ...
        (store_mul, ":begin_mesh", 0, "$g_presentation_obj_banner_selection_1"),
        (val_add, ":begin_mesh", banner_meshes_begin),
        (store_add, ":try_end_2", ":begin_mesh", 209), ##Where banners end (on the last one)
